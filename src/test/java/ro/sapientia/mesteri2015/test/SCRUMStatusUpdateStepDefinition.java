...
public class SCRUMStatusUpdateStepDefinition {
	...
	public void I_edit_the_scrum_list_s_first_status() throws Throwable {
	...
	public void I_enter_in_the_title_textbox_and_I_push_the_update_button(String updateTitle) throws Throwable {
		...
		updateButton.click();
		//driver.wait(1000);
		WebElement titleField = driver.findElement(By.id("status-title"));
		titleField.sendKeys(Keys.CONTROL + "a");
		titleField.sendKeys(Keys.DELETE);
		titleField.sendKeys(updateTitle);
		
		WebElement updateStatusButton = driver.findElement(By.id("update-status-button"));
		updateStatusButton.click();
	
	}
	
	@Then("^I should get result \"([^\"]*)\" in new statuses list$")
	public void I_should_get_result_in_new_statuses_list(String expectedResult) throws Throwable {
	    // Express the Regexp above with the code you wish you had
		WebElement titleText = driver.findElement(By.id("status-title"));
